...
/**
 * Synonym of Query#group()
 *
 * @method Query#groupby
 * @param {String|Object} group - Group field or array of group fields
 * @returns {Query.<T>}
 */
/**
 * Set query group by
 ...
 * @returns {Query.<T>}
 */
Query.prototype.group =
Query.prototype.groupby = function(group) {
  if (this._soql) {
    throw Error("Cannot set group for the query which has already built SOQL.");
  }
